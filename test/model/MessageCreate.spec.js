...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.MessageCreate();
  });
  ...
  describe('MessageCreate', function() {
    it('should create an instance of MessageCreate', function() {
      ...
      //var instance = new OpenAiAssistantsApi.MessageCreate();
      //expect(instance).to.be.a(OpenAiAssistantsApi.MessageCreate);
    });

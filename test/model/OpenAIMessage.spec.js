...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.OpenAIMessage();
  });
  ...
  describe('OpenAIMessage', function() {
    it('should create an instance of OpenAIMessage', function() {
      // uncomment below and update the code to test OpenAIMessage
      //var instance = new OpenAiAssistantsApi.OpenAIMessage();
      //expect(instance).to.be.a(OpenAiAssistantsApi.OpenAIMessage);
    });

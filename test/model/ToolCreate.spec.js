...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.ToolCreate();
  });
  ...
  describe('ToolCreate', function() {
    it('should create an instance of ToolCreate', function() {
      // uncomment below and update the code to test ToolCreate
      //var instance = new OpenAiAssistantsApi.ToolCreate();
      //expect(instance).to.be.a(OpenAiAssistantsApi.ToolCreate);
    });

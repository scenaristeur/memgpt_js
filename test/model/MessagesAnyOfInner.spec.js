...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.MessagesAnyOfInner();
  });
  ...
  describe('MessagesAnyOfInner', function() {
    it('should create an instance of MessagesAnyOfInner', function() {
      // uncomment below and update the code to test MessagesAnyOfInner
      //var instance = new OpenAiAssistantsApi.MessagesAnyOfInner();
      //expect(instance).to.be.a(OpenAiAssistantsApi.MessagesAnyOfInner);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new OpenAiAssistantsApi.ValidationError();
      //expect(instance).to.be.a(OpenAiAssistantsApi.ValidationError);
    });

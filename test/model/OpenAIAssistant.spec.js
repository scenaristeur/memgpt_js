...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.OpenAIAssistant();
  });
  ...
  describe('OpenAIAssistant', function() {
    it('should create an instance of OpenAIAssistant', function() {
      // uncomment below and update the code to test OpenAIAssistant
      //var instance = new OpenAiAssistantsApi.OpenAIAssistant();
      //expect(instance).to.be.a(OpenAiAssistantsApi.OpenAIAssistant);
    });

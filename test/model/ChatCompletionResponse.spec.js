...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.ChatCompletionResponse();
  });
  ...
  describe('ChatCompletionResponse', function() {
    it('should create an instance of ChatCompletionResponse', function() {
      // uncomment below and update the code to test ChatCompletionResponse
      //var instance = new OpenAiAssistantsApi.ChatCompletionResponse();
      //expect(instance).to.be.a(OpenAiAssistantsApi.ChatCompletionResponse);
    });

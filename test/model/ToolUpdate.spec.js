...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.ToolUpdate();
  });
  ...
  describe('ToolUpdate', function() {
    it('should create an instance of ToolUpdate', function() {
      // uncomment below and update the code to test ToolUpdate
      //var instance = new OpenAiAssistantsApi.ToolUpdate();
      //expect(instance).to.be.a(OpenAiAssistantsApi.ToolUpdate);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.AuthResponse();
  });
  ...
  describe('AuthResponse', function() {
    it('should create an instance of AuthResponse', function() {
      ...
      //var instance = new OpenAiAssistantsApi.AuthResponse();
      //expect(instance).to.be.a(OpenAiAssistantsApi.AuthResponse);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.StepDefaults();
  });
  ...
  describe('StepDefaults', function() {
    it('should create an instance of StepDefaults', function() {
      // uncomment below and update the code to test StepDefaults
      //var instance = new OpenAiAssistantsApi.StepDefaults();
      //expect(instance).to.be.a(OpenAiAssistantsApi.StepDefaults);
    });

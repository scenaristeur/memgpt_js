...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.MemGPTResponse();
  });
  ...
  describe('MemGPTResponse', function() {
    it('should create an instance of MemGPTResponse', function() {
      // uncomment below and update the code to test MemGPTResponse
      //var instance = new OpenAiAssistantsApi.MemGPTResponse();
      //expect(instance).to.be.a(OpenAiAssistantsApi.MemGPTResponse);
    });

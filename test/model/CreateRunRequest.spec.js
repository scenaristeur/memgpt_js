...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.CreateRunRequest();
  });
  ...
  describe('CreateRunRequest', function() {
    it('should create an instance of CreateRunRequest', function() {
      ...
      //var instance = new OpenAiAssistantsApi.CreateRunRequest();
      //expect(instance).to.be.a(OpenAiAssistantsApi.CreateRunRequest);
    });

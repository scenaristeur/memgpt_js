...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.Passage();
  });
  ...
  describe('Passage', function() {
    it('should create an instance of Passage', function() {
      // uncomment below and update the code to test Passage
      //var instance = new OpenAiAssistantsApi.Passage();
      //expect(instance).to.be.a(OpenAiAssistantsApi.Passage);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new OpenAiAssistantsApi.HTTPValidationError();
      //expect(instance).to.be.a(OpenAiAssistantsApi.HTTPValidationError);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAiAssistantsApi.CreateAssistantFileRequest();
  });
  ...
  describe('CreateAssistantFileRequest', function() {
    it('should create an instance of CreateAssistantFileRequest', function() {
      // uncomment below and update the code to test CreateAssistantFileRequest
      //var instance = new OpenAiAssistantsApi.CreateAssistantFileRequest();
      //expect(instance).to.be.a(OpenAiAssistantsApi.CreateAssistantFileRequest);
    });
